...
export const translations = {
  fr: {
    ...
    newMentions: 'nouvelles mentions',
    youHaveMentions: 'Tu as été mentionné dans un match',
    save: 'Sauvegarder',
    error: 'Erreur',
    success: 'Succès',
    loading: 'Chargement...',
    ...
    usernameChangeCooldown: 'Tu ne peux changer ton nom d\'utilisateur qu\'une fois par 30 jours',
  ...
  en: {
    ...
    youHaveMentions: 'You were mentioned in a match',
    save: 'Save',
    error: 'Error',
    success: 'Success',
    loading: 'Loading...',
