export const registerTranslations = {
  fr: {
    ...
    stateProvincePlaceholder: 'Sélectionnez votre état/province',
    ageConfirmation: 'Je confirme avoir 18 ans ou plus',
    continue: 'Continuer',
    legalMention: 'En créant un compte, vous acceptez nos conditions d\'utilisation et notre politique de confidentialité.',
    ...
    errorSelectState: 'Veuillez sélectionner votre état/province',
    errorAge: 'Vous devez avoir 18 ans ou plus pour créer un compte',
    ...
    usernameHint: 'Sera affiché dans le chat et votre profil',
    // Step 2 errors
    ...
    newsletterQuestion: 'Souhaitez-vous recevoir notre infolettre ?',
    newsletterHint: 'Restez informé des dernières nouvelles sportives, des promotions exclusives et des événements spéciaux.',
    yesSubscribe: 'Oui, je m\'inscris',
    noThanks: 'Non merci',
    createMyAccount: 'Créer mon compte',
    // Step 3 errors
    errorNewsletterChoice: 'Veuillez indiquer si vous souhaitez recevoir notre infolettre',

    // Success
    successTitle: 'Inscription réussie !',
    successMessage: 'Vérifiez votre courriel pour confirmer votre compte, puis connectez-vous.',
